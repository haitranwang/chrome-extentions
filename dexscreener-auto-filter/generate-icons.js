// Node.js script to generate icons for Chrome extension from DexScreener logo
...
const logoPath = path.join(__dirname, 'dex-screener-logo.png');

async function generateIcons() {
  try {
    // Load the DexScreener logo
    ...
    if (error.code === 'ENOENT') {
      ...
      console.error('   Please make sure dex-screener-logo.png exists in the same directory.');
    }
    process.exit(1);
  }
}
